...
class Config(context: Context) : BaseConfig(context) {
    ...
    var playOnBluetooth: Boolean
        get() = prefs.getBoolean(PLAY_ON_BLUETOOTH, false)
        set(playOnBluetooth) = prefs.edit().putBoolean(PLAY_ON_BLUETOOTH, playOnBluetooth).apply()
